...
class ChatSessionPolicy
{
    ...
    {
        return $user->can('view_any_chat::session');
    }
    ...
    {
        return $user->can('view_chat::session');
    }
    ...
    {
        return $user->can('create_chat::session');
    }
    ...
    {
        return $user->can('update_chat::session');
    }
    ...
    {
        return $user->can('delete_chat::session');
    }
    ...
    {
        return $user->can('delete_any_chat::session');
    }
     ...
     */
    public function replicate(User $user, ChatSession $chatSession): bool
    {
