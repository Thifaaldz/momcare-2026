...
class ChatMessagePolicy
{
    ...
    {
        return $user->can('view_any_chat::message');
    }
    ...
    {
        return $user->can('view_chat::message');
    }
    ...
    {
        return $user->can('create_chat::message');
    }
    ...
    {
        return $user->can('update_chat::message');
    }
    ...
    {
        return $user->can('delete_chat::message');
    }
    ...
    {
        return $user->can('delete_any_chat::message');
    }
     ...
     */
    public function replicate(User $user, ChatMessage $chatMessage): bool
    {
